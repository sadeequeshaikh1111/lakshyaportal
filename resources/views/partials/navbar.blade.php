...
<div class="bg-gray-800 text-white h-screen w-64 flex-shrink-0">
    <ul class="p-4">
        ...
        <li><a href="#" class="nav-link text-gray-300 hover:text-gray-100 px-4 py-2 rounded" data-target="educational-details">Educational details</a></li>
        <li><a href="#" class="nav-link text-gray-300 hover:text-gray-100 px-4 py-2 rounded" data-target="upload-documents">Upload documents</a></li>
